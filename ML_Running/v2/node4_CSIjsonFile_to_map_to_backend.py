...
class KNNModel():
    def __init__(self):
        self.model=joblib.load('knn_model_v1.pkl')
    def predict_from_single_csi():
        pass
    def get_map_from_csi():
        pass
        
class KNNModel():
    def __init__(self):
        self.model=joblib.load('mlp_model_v1.pkl')
    def predict_from_single_csi():
        pass
    def get_map_from_csi():
        pass
...
model=joblib.load('mlp_model_v1.pkl')
